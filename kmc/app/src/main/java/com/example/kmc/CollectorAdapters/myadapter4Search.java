...
public class myadapter4Search extends RecyclerView.Adapter<myadapter4Search.myviewholder>
{
    ArrayList<Individual> datalist;
    ArrayList<SelectionElements> dataAadhar=new ArrayList<>();
    String village;

    public myadapter4Search(ArrayList<Individual> datalist, String village) {
    ...
    @NonNull
    @Override
    public myadapter4Search.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter4Search.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter4Search.myviewholder holder, @SuppressLint("RecyclerView") int position) {
