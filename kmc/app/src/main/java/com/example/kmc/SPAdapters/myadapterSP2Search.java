...
public class myadapterSP2Search extends RecyclerView.Adapter<myadapterSP2Search.myviewholder>
{
    ArrayList<Individual> datalist;
    String village1;
    String village2;

    public myadapterSP2Search(ArrayList<Individual> datalist, String village1, String village2) {
    ...
    @NonNull
    @Override
    public myadapterSP2Search.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapterSP2Search.myviewholder(view);
    }
