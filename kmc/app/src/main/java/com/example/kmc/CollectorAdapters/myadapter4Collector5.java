...
public class myadapter4Collector5 extends RecyclerView.Adapter<myadapter4Collector5.myviewholder>
{
    ...
    public myadapter4Collector5(ArrayList<Individual> datalist, String village, Context context, List l) {
    ...
    @NonNull
    @Override
    public myadapter4Collector5.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter4Collector5.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter4Collector5.myviewholder holder, @SuppressLint("RecyclerView") int position) {
