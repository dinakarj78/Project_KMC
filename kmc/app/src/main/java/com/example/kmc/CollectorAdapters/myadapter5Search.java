...
public class myadapter5Search extends RecyclerView.Adapter<myadapter5Search.myviewholder>
{
    ...
    @NonNull
    @Override
    public myadapter5Search.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter5Search.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter5Search.myviewholder holder, @SuppressLint("RecyclerView") int position) {
