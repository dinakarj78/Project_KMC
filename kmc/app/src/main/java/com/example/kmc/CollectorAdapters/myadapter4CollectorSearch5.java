...
import com.example.kmc.CLogin.CollectorUserDetailsAmountToDB2;
...
public class myadapter4CollectorSearch5 extends RecyclerView.Adapter<myadapter4CollectorSearch5.myviewholder>
{
    ArrayList<Individual> datalist;
    String district;

    public myadapter4CollectorSearch5(ArrayList<Individual> datalist, String district) {
    ...
    @NonNull
    @Override
    public myadapter4CollectorSearch5.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter4CollectorSearch5.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter4CollectorSearch5.myviewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(holder.t1.getContext(), CollectorUserDetailsAmountToDB2.class);
