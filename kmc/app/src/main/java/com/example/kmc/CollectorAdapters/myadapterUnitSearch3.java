...
public class myadapterUnitSearch3 extends RecyclerView.Adapter<myadapterUnitSearch3.myviewholder>
{
...
>>>>>>> 2f137f127f3002c0b05359f66412b5b8c0f2cc4f
    ...
    @NonNull
    @Override
    public myadapterUnitSearch3.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapterUnitSearch3.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapterUnitSearch3.myviewholder holder, @SuppressLint("RecyclerView") int position) {
