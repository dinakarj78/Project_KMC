...
import com.example.kmc.CLogin.CollectorUserDetailsAmountDBToBen2;
...
public class myadapter4Collector6 extends RecyclerView.Adapter<myadapter4Collector6.myviewholder>
{
    ...
    public myadapter4Collector6(ArrayList<Individual> datalist, String village, Context context, List2 l) {
    ...
    @NonNull
    @Override
    public myadapter4Collector6.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter4Collector6.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter4Collector6.myviewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(holder.t1.getContext(), CollectorUserDetailsAmountDBToBen2.class);
