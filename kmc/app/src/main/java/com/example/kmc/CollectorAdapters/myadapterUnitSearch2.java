...
public class myadapterUnitSearch2 extends RecyclerView.Adapter<myadapterUnitSearch2.myviewholder>
{
...
<<<<<<< HEAD
    ...
    public myadapterUnitSearch2(ArrayList<Individual> datalist, String district, Context context, List l) {
        this.datalist = datalist;
        this.district=district;
        this.list=l;
=======

    public myadapterUnitSearch2(ArrayList<Individual> datalist, String district) {
        this.datalist = datalist;
        this.district=district;
>>>>>>> 2f137f127f3002c0b05359f66412b5b8c0f2cc4f
    }
    ...
    @NonNull
    @Override
    public myadapterUnitSearch2.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapterUnitSearch2.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapterUnitSearch2.myviewholder holder, @SuppressLint("RecyclerView") int position) {
