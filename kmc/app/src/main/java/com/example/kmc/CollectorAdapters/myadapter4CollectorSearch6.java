...
public class myadapter4CollectorSearch6 extends RecyclerView.Adapter<myadapter4CollectorSearch6.myviewholder>
{
    ...
    @NonNull
    @Override
    public myadapter4CollectorSearch6.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new myadapter4CollectorSearch6.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myadapter4CollectorSearch6.myviewholder holder, @SuppressLint("RecyclerView") int position) {
